...
public class Puzzle
{
    ...
    public string Category { get; init; } = "";        // "角部死活" / "边部死活" / "中央死活"
...
public static class PuzzleLibrary
{
    public static IReadOnlyList<Puzzle> All { get; } = new List<Puzzle>
    {
        ...
        new Puzzle
        {
            ...
            Goal = "黑棋做活：扩大眼位，不被白棋从中间切断",
            Hint = "在 (4,1) 落子连接下方，形成 4 子直四。",
        ...
        new Puzzle
        {
            ...
            Goal = "黑 4 子直四已经活了——白棋任何走法都杀不掉",
            Hint = "随便走任何 1 个白棋不能扑死的点，黑棋都活。",
        ...
        new Puzzle
        {
            ...
            Goal = "黑棋 8 子围 1 真眼（中央 (2,2)），黑棋已经活了",
            Hint = "白棋任何走法都杀不死黑棋。黑棋中央 (2,2) 是真眼。",
        ...
        new Puzzle
        {
            ...
            Goal = "黑 6 子大板六，黑棋已活（边部 6 子必活）",
            Hint = "黑棋已经活了——白棋任何走法都杀不死。",
