    ...
    public StyledMessageWindow(string title, string message, StyledDialogKind kind, bool destructiveConfirm = false)
    {
        ...
        switch (kind)
        {
            case StyledDialogKind.Error:
                StyleAsDanger();
                DialogIcon.Text = "⚠";
                AddButton("关闭", StyledDialogResult.Ok, isPrimary: true, isDefault: true, isCancel: true);
                break;
            case StyledDialogKind.Warning:
                StyleAsDanger();
                DialogIcon.Text = "⚠";
                AddButton("好", StyledDialogResult.Ok, isPrimary: true, isDefault: true, isCancel: true);
                break;
            ...
            case StyledDialogKind.Confirm:
                DialogIcon.Text = "❓";
                AddButton("取消", StyledDialogResult.No, isPrimary: false, isDefault: false, isCancel: true);
                AddButton("确认", StyledDialogResult.Yes, isPrimary: true, isDefault: true, isCancel: false, destructive: destructiveConfirm);
                break;
        }
    }
